...
const I18N_LANDING = {
  ...
  mai: {
    nav_features: "विशेषतासभ",
    nav_how_it_works: "ई कोना काज करैत अछि",
    nav_packages: "पैकेज आ मूल्य",
    nav_signin: "साइन इन",
    hero_badge: "टेक्स्ट-टू-ऐप इंजन",
    hero_title_1: "अपन विचार केँ पाँखि दिअ।",
    hero_title_2: "60 सेकंड मे अपन कस्टम ऐप बनाउ।",
    hero_subtitle: "कोडिंग केर कोनो आवश्यकता नहि। न डेवलपर, न सर्वर।<br />बस बताउ अहाँ की बनाबय चाहैत छी — आ ऐप केँ जीवंत होइत देखू।",
    hero_cta: "ऐप बनाबय लेल Google सँ साइन इन करु",
    hero_see_more: "देखू आन लोक की बना रहल छथि ↓",
    hero_trust_1: "✓ कोनो तकनीकी कौशल केर आवश्यकता नहि",
    hero_trust_2: "✓ 60 सेकंड सँ कम मे लाइव वेब ऐप",
    hero_trust_3: "✓ अहाँक कोड, अहाँक स्वामित्व, सदति लेल",
    cap_tag: "अहाँ की कऽ सकैत छी",
    cap_title: "चारि शक्तिशाली क्षमता। एक मंच।",
    cap_subtitle: "अहाँक खाता सभ किछु अनलॉक करैत अछि — विश्लेषण, दस्तावेज़ रूपांतरण, शोध आ ऐप निर्माण — केवल सरल बातचीत द्वारा।",
    cap_vision_title: "छवि आ दस्तावेज़ विश्लेषण",
    cap_vision_desc: "कोनो फोटो, PDF, स्प्रेडशीट वा रिपोर्ट अपलोड करु। प्रश्न पूछू, निष्कर्ष निकालू, सारांश बनाउ वा अनुवाद करु — तुरंत।",
    cap_convert_title: "प्रीमियम दस्तावेज़ रूपांतरण",
    cap_convert_desc: "बोर्ड-रेडी रिपोर्ट, पेशेवर प्रस्तुतियाँ (PPT), आ स्प्रेडशीट सेकंडों मे तैयार करु।",
    cap_chat_title: "AI अनुसंधान आ तर्क क्षमता",
    cap_chat_desc: "जटिल समस्याक गहिर विश्लेषण। समीकरण हल करु, शोध करु, प्रस्ताव तैयार करु, केस स्टडीज केर विश्लेषण करु।",
    cap_build_title: "वेब ऐप्स बनाउ आ डिप्लॉय करु",
    cap_build_desc: "मुख्य आकर्षण। कोनो सॉफ्टवेयर केर अपन भाषा मे विवरण दिअ — हमर इंजन एकटा सम्पूर्ण कार्यात्मक वेब ऐप डिजाइन, कोड आ लाइव डिप्लॉय करत।",
    usecase_tag: "टेक्स्ट-टू-ऐप इंजन",
    usecase_title: "सभ विषय सँ। सभ सपना सँ।",
    usecase_subtitle: "क्लासरूम सँ बोर्डरूम धरि। जँ अहाँ कल्पना कऽ सकैत छी, तँ अहाँ बना सकैत छी।<br /><br /><strong style=\"color:var(--purple-light);\">बस टाइप करु अहाँ की चाहैत छी, आ हमर टेक्स्ट-टू-ऐप इंजन तुरंत एकटा लाइव, पूर्ण रूप सँ कार्यात्मक वेब एप्लिकेशन डिजाइन, कोड आ डिप्लॉय कऽ दैत अछि।</strong>",
    usecase_heading: "आइ अहाँ की बनाबय चाहब?",
    usecase_corp_title: "कॉर्पोरेट आ संचालन",
    usecase_corp_desc: "बैंक केर क्षेत्रीय मेट्रिक्स ट्रैक करय वाला डैशबोर्ड, वा रेलवे शिफ्ट आ कार्गो शेड्यूल।",
    usecase_found_title: "संस्थापक आ एजेंसियाँ",
    usecase_found_desc: "एकटा पूर्ण रूप सँ कार्यात्मक SaaS डैशबोर्ड, क्लाइंट ऑनबोर्डिंग पोर्टल, वा स्वचालित लीड-जेनरेशन टूल लॉन्च करु।",
    usecase_local_title: "स्थानीय व्यापार आ सेवा",
    usecase_local_desc: "प्लंबर केर स्वचालित बुकिंग सिस्टम, वा स्थानीय बेकरी केर लाइव इन्वेंट्री आ डिलीवरी फॉर्म।",
    usecase_stud_title: "विद्यार्थी आ शिक्षक",
    usecase_stud_desc: "मास्टर्स थीसिस लेल इंटरैक्टिव स्टडी वॉल्ट, मेडिकल स्कूल लेल कस्टम फ्लैशकार्ड ऐप, वा सहयोगी वर्कस्पेस।",
    usecase_home_title: "व्यक्तिगत आ घरेलू",
    usecase_home_desc: "पारिवारिक शेड्यूल आ बजट व्यवस्थित करय लेल, वा अहाँक व्यक्तिगत रेसिपी हब।",
    usecase_brand_title: "ऑनलाइन उपस्थिति",
    usecase_brand_desc: "फोटोग्राफर केर पोर्टफोलियो, सलाहकार केर व्यक्तिगत ब्रांड साइट, स्टार्टअप केर वेटलिस्ट पेज।",
    how_tag: "प्रक्रिया",
    how_title: "टेक्स्ट-टू-ऐप इंजन कोना काज करैत अछि",
    how_subtitle: "अहाँक विचार सँ लाइव एप्लिकेशन धरि — चारि चरण मे, साठ सेकंड सँ कम मे।",
    step1_title: "Google सँ साइन इन करु",
    step1_desc: "एक क्लिक सँ अहाँक निजी, एन्क्रिप्टेड वर्कस्पेस बनैत अछि, जे Google द्वारा सुरक्षित अछि।",
    step2_title: "अपन एप्लिकेशन केर विवरण दिअ",
    step2_desc: "अपन भाषा मे टाइप करु अहाँ की चाहैत छी। हमर इंजन सटीक समझ लेल बुद्धिमान अनुवर्ती प्रश्न पूछैत अछि।",
    step3_title: "इंजन एकरा बनबैत अछि",
    step3_desc: "AppBuilder UI डिजाइन करैत अछि, कोड लिखैत अछि, लॉजिक संभालैत अछि आ एकटा पूर्ण प्रोडक्शन-रेडी वेब ऐप बनबैत अछि।",
    step4_title: "ई तुरंत लाइव भऽ जाइत अछि",
    step4_desc: "पब्लिश पर क्लिक करु। अहाँक ऐप केँ एकटा लाइव URL भेटैत अछि जकरा अहाँ तुरंत साझा कऽ सकैत छी।",
    pricing_tag: "मूल्य",
    pricing_title: "अपन AppBuilder प्लान चुनू",
    pricing_subtitle: "एकमुश्त सॉफ्टवेयर खरीद। कोनो गुप्त शुल्क नहि। अपन कोड केर सदति लेल मालिक बनू।",
    promise_title: "AppBuilder केर वचन",
    promise_1_title: "शून्य कोडिंग",
    promise_1_desc: "अहाँ टाइप करु। हम बनयब। कोनो अपवाद नहि।",
    promise_2_title: "तत्काल लाइव लिंक",
    promise_2_desc: "पब्लिश पर क्लिक करय मात्र सँ साझा करय योग्य URL।",
    promise_3_title: "सदति लेल अहाँक अपन",
    promise_3_desc: "पूर्ण सोर्स कोड स्वामित्व। कोनो लॉक-इन नहि।",
    promise_4_title: "प्रीमियम दस्तावेज़",
    promise_4_desc: "वर्ड, एक्सेल आ पावरपॉइंट जे पेशेवर सलाहकार स्तर केर देखाइत अछि।",
    sec_title: "अहाँक विचार, पूर्ण रूप सँ सुरक्षित",
    sec_desc: "हम अहाँ सँ साइन इन करय लेल किएक कहैत छी? अहाँक जनरेट कएल ऐप अहाँक बौद्धिक संपदा अछि। हम तुरंत एकटा निजी, एन्क्रिप्टेड वर्कस्पेस बनाबय लेल <strong>Google प्रमाणीकरण</strong> केर उपयोग करैत छी। अहाँक कोड, डेटा आ लाइव लिंक सुरक्षित रूप सँ सहेजल जाइत अछि आ केवल अहाँ लेल सुलभ अछि।",
    sec_cta: "⚡ ऐप बनाबय लेल Google सँ सुरक्षित रूप सँ साइन इन करु",
    sec_note: "आइ अपन पहिल ऐप लॉन्च करु। साइन इन लेल कोनो क्रेडिट कार्डक आवश्यकता नहि।",
    footer_text: "ऐप्स बनाउ · किछुओ विश्लेषण करु · दस्तावेज़ रूपांतरित करु · Google Gemini द्वारा संचालित",
    footer_signin: "Google सँ साइन इन करु",
  }
};
