...
const I18N_LANDING = {
  en: {
    ...
    nav_signin: "Sign In",
    hero_badge: "Text-to-App Engine · Powered by Google Gemini AI",
  ...
  hi: {
    ...
    nav_signin: "साइन इन",
    hero_badge: "टेक्स्ट-टू-ऐप इंजन · Google Gemini AI द्वारा संचालित",
  ...
  es: {
    ...
    hero_badge: "Motor Texto-a-App · Desarrollado por Google Gemini AI",
  ...
  te: {
    ...
    nav_signin: "సైన్ ఇన్",
    hero_badge: "టెక్స్ట్-టు-యాప్ ఇంజిన్ · Google Gemini AI శక్తితో",
